...
<body {{-- <i class="fa fa-cube"> --}} <nav class="navbar navbar-expand-xl navbar-dark bg-dark">
...
@endphp --}}
            ...
            <a href="#" class="nav-item nav-link" style="color: black"><i class="fa fa-bell">
                    @if (Auth::user()->unreadNotifications->count() > 0)
                        <span style="color: red">{{ Auth::user()->unreadNotifications->count() }}</span>
                    @endif
                </i><span>Notifications</span></a>
            {{-- photo de profile --}}
            <a href="#" class="nav-item nav-link" style="color: black"><i class="fa-solid fa-circle-user avatar"
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="#" class="dropdown-item"><i class="fa fa-sliders"></i> changer mot depasse</a>
