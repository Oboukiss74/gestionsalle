...
@section('liens')
    <a href="{{ route('tableau_de_bord') }}" class="nav-item nav-link"
        style="transform: translate(-100px,0); color: white;"><i class="fa-solid fa-users"></i></i><span>Les
            utilisateurs</span></a>
    <a href="{{ route('ajouterutilisateur') }}" class="nav-item nav-link"><i class="fa-solid fa-address-card"
            style="color: white"></i><span>Ajouter un utilisateur</span></a>
@endsection
@section('infos')
