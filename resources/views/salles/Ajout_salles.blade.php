            ...
            <form action="{{ route('enregistrer_salle') }}" method="POST">
                ...
                <div class="formbold-input-flex" style="width: 950px">
                    <div style="width: 650px" class="case_saisie">
                        <label for="lastname" class="formbold-form-label"> nom de la salle </label>
                    ...
                    <div style="width: 950px">
                        ...
                        <input type="number" name="code" id="lastname" placeholder="code de la salle"
                            class="formbold-form-input" />
                    </div>

                    <div style="width: 650px">
                        <label for="lastname" class="formbold-form-label"> nombre de place</label>
                        <input type="number" name="nombre_place" id="lastname" placeholder="N° de la salle"
                            class="formbold-form-input" />
                    </div>
                </div>
                ...
                <div class="formbold-input-flex">
                    ...
                    <div style="width: 650px">
                        ...
                        <input type="number" name="prix" id="prix" placeholder="nombre de place"
                            class="formbold-form-input" />
                    </div>
