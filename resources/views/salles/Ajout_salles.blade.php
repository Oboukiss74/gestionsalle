...
<body>
    ...
    <div class="formbold-main-wrapper" style="padding: 8%;padding-right: initial;">
            ...
            <form action="{{ route('enregistrer_salle') }}" method="POST">
                ...
                <div class="formbold-input-flex">
                    <div>
                        ...
                        <input type="text" name="nom" id="firstname" placeholder="nom de la salle"
                            class="formbold-form-input" style="width: 350px;" />
                    </div>
                ...
                <div class="formbold-input-flex">
                    ...
                    <div>
                        ...
                        <select class="formbold-form-input" name="taille" id="occupation" style="width: 350px;">
                ...
                <div class="formbold-mb-3">
                    ...
                    <input type="text" name="tarif" id="age" class="formbold-form-input"
                        placeholder="le prix de la salle" style="width: 350px;" />
                </div>

                <div class="formbold-mb-3">
                    <label for="dob" class="formbold-form-label"> Statut de la salle</label>
                    <select name="statut" id="statut" class="formbold-form-input" style="width: 350px;">
